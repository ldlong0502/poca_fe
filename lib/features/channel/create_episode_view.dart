...
class CreateEpisodeView extends StatelessWidget {
  const CreateEpisodeView({super.key, required this.channelDetailCubit});
            ...
            Expanded(
              child: SingleChildScrollView(
                child: Padding(
                  ...
                  child: BlocProvider(
                    create: (context) =>
                    CreateEpisodeCubit(channelDetailCubit)
                      ..load(),
                    child: BlocBuilder<CreateEpisodeCubit, int>(
                      builder: (context, state) {
                        ...
                        final cubit = context.read<CreateEpisodeCubit>();
...
class CreateEpisodeCubit extends Cubit<int> {
  CreateEpisodeCubit(this.channelDetailCubit) : super(0);
  final ChannelDetailCubit channelDetailCubit;
  ...
  load() async {
    listPodcast = await ApiPodcast.instance.getListPodcastByChannelId(
        channelDetailCubit.channel!.id);
    emit(state + 1);
  }
